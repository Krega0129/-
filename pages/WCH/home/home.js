...
Page({
  data: {
    ...
    pageNum: 1,
    cateImgList: [
      BASE_URL + '/images/a1.png',
      BASE_URL + '/images/a2.png',
      BASE_URL + '/images/a3.png',
      BASE_URL + '/images/a4.png',
      BASE_URL + '/images/a5.png',
      BASE_URL + '/images/a6.png',
      BASE_URL + '/images/a7.png'
    ],
    // cateImgList: [
